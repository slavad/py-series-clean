...
class Restorer(object):
    ...
    def __init__(self, super_resultion_vector, iterations, number_of_freq_estimations, time_grid, max_freq):
        ...
        if iterations != 0:
            ...
            self.__freq_vector = self.__index_vector*self.__max_freq/self.__number_of_freq_estimations
    ...
    def restore(self):
        ...
        if self.__iterations == 0:
            ...
            return self.__uniform_time_grid, clean_spectrum, correlogram, uniform_series, self.__freq_vector, freqs, amplitudes, phases
